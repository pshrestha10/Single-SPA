...
//       },
//       plotOptions: {
//         column: { pointPadding: 0.1, borderWidth: 0,events: {
//           click: (event: any) => {
//             this.storeClickedData(event.point);
//           }
//         } }
...
//       y: point.y
//     };
//     localStorage.setItem('clickedChartData', JSON.stringify(clickedData));
//     console.log('Stored clicked data:', clickedData);
//   }
// }
...
export class ChartsComponent {
  ...
  storeClickedData(point: any): void {
    ...
    this.filterApplied.emit(clickedData);
  }
}
